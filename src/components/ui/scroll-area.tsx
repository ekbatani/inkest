...
function ScrollArea({
  ...
  return (
    <ScrollAreaPrimitive.Root
      ...
      {...props}
    >
      {/* `max-height: inherit` lets `max-h-*` on the Root cap the scrolling
          viewport — `height: 100%` alone can't, since it resolves to `auto`
